...
function CombinedRequestCard({request,quote,shipment,finalInvoice,job,allJobs,activeCount,onChanged,onNotice}:{request:StoredRequest;quote:StoredQuote|null;shipment:ShipmentRecord|null;finalInvoice:FinalInvoiceRecord|null;job:QueueJob|null;allJobs:QueueJob[];activeCount:number;onChanged:()=>Promise<void>;onNotice:(n:Notice)=>void}){
